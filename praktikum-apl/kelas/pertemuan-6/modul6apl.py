...
Original file is located at
    https://colab.research.google.com/drive/14KpV_6CeFSq2VUeNoQ5FzAKDwVKkRq3n
"""

# Commented out IPython magic to ensure Python compatibility.
# %%bash
# cat > binarySearch.cpp << 'EOF'
# #include<iostream>
# #include<vector>
# #include<algorithm>
# using namespace std;
...
# }
# EOF
# g++ -o jumpSearch jumpSearch.cpp
# ./jumpSearch

# Commented out IPython magic to ensure Python compatibility.
# %%bash
# cat > interpolationSearch.cpp << 'EOF'
# #include<iostream>
# #include<vector>
# using namespace std;
# 
...
# }
# EOF
# g++ -o interpolationSearch interpolationSearch.cpp
# ./interpolationSearch