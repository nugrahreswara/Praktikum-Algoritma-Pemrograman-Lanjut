...
Original file is located at
    https://colab.research.google.com/drive/1ec3cIktIb9TtV49Ifq5GnhWjL3EEvvL9
"""

# Commented out IPython magic to ensure Python compatibility.
# %%bash
# cat > bubbleSort.cpp << 'EOF'
# #include <iostream>
# #include <utility>
# using namespace std;
# 
...
# Commented out IPython magic to ensure Python compatibility.
# %%bash
# cat > insertionSortStruct.cpp << 'EOF'
# #include <iostream>
# #include <string>
# using namespace std;
# 
...
# }
# EOF
# g++ -std=c++11 -o insertionSortStruct insertionSortStruct.cpp
# ./insertionSortStruct