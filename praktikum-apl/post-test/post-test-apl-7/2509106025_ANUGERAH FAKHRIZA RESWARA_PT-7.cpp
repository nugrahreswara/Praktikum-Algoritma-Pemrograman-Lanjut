// ==================== USER-DEFINED LIBRARY: error_handling.h ====================
...
// Kelas dasar untuk semua exception
class ExceptionBase {
protected:
    char pesan[200];
public:
...
class InputError : public ExceptionBase {
public:
    InputError(const char* msg = "Input tidak valid!") : ExceptionBase(msg) {}
};

// Exception untuk user tidak ditemukan
class UserNotFoundError : public ExceptionBase {
public:
    UserNotFoundError(const char* msg = "User tidak ditemukan!") : ExceptionBase(msg) {}
};

// Exception untuk nama duplikat saat registrasi
class DuplicateNameError : public ExceptionBase {
public:
    DuplicateNameError(const char* msg = "Nama sudah terdaftar!") : ExceptionBase(msg) {}
};

// Exception untuk kapasitas VM penuh
class VMCapacityFullError : public ExceptionBase {
public:
    VMCapacityFullError(const char* msg = "Kapasitas VM sudah penuh!") : ExceptionBase(msg) {}
};

// Exception untuk kapasitas user penuh
class UserCapacityFullError : public ExceptionBase {
public:
    UserCapacityFullError(const char* msg = "Kapasitas user sudah penuh!") : ExceptionBase(msg) {}
};

// Exception untuk VM tidak ditemukan
class VMNotFoundError : public ExceptionBase {
public:
    VMNotFoundError(const char* msg = "VM tidak ditemukan!") : ExceptionBase(msg) {}
};

// Exception untuk indeks di luar batas
class OutOfRangeError : public ExceptionBase {
public:
    OutOfRangeError(const char* msg = "Nomor di luar batas!") : ExceptionBase(msg) {}
};
...
void buatVM(VM *daftarVM, int &jumlahVM, Pengguna *daftarPengguna, int jumlahPengguna) {
    ...
    if (!pemilikAda) {
        throw UserNotFoundError("Pemilik tidak ditemukan. VM gagal dibuat.");
    }
    ...
    if (cin.fail()) {
        cin.clear();
        cin.ignore(1000, '\n');
        throw InputError("CPU harus berupa angka!");
    }
    ...
    if (cin.fail()) {
        cin.clear();
        cin.ignore(1000, '\n');
        throw InputError("RAM harus berupa angka!");
    }
    ...
    if (cin.fail()) {
        cin.clear();
        cin.ignore(1000, '\n');
        throw InputError("Storage harus berupa angka!");
    }
    cin.ignore();
                ...
                if (strcmp(roleLogin, "admin") == 0) {
                    ...
                    while (!logout) {
                        ...
                        switch (pilihan) {
                            ...
                            case 3: 
                                try {
                                    ubahDataUser(daftarPengguna, jumlahPengguna, daftarVM, jumlahVM, indeksLogin);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                            case 4: 
                                try {
                                    hapusUser(daftarPengguna, jumlahPengguna, daftarVM, jumlahVM, indeksLogin);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                            case 5: 
                                try {
                                    buatVM(daftarVM, jumlahVM, daftarPengguna, jumlahPengguna);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                            ...
                            case 7: 
                                try {
                                    konfigurasiVM(daftarVM, jumlahVM, daftarPengguna, jumlahPengguna);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                            ...
                            case 10: 
                                try {
                                    ubahProfilAdmin(daftarPengguna, indeksLogin, daftarVM, jumlahVM, jumlahPengguna);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                ...
                // Menu user
                    ...
                    while (!logout) {
                        ...
                        switch (pilihan) {
                            ...
                            case 3: 
                                try {
                                    ubahProfilUser(daftarPengguna, indeksLogin, daftarVM, jumlahVM, jumlahPengguna);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
                            case 4: 
                                try {
                                    hapusAkunUser(daftarPengguna, jumlahPengguna, daftarVM, jumlahVM, indeksLogin, logout);
                                } catch (ExceptionBase& e) {
                                    cout << "Error: " << e.what() << endl;
                                }
                                break;
